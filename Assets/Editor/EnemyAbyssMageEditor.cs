    ...
    private readonly List<Section> sections = new List<Section>
    {
        ...
        new Section(
            ...
            new[]
            {
                ...
                new FieldInfo("abyssFireballDamage", "Abyss Fireball Damage", "skill2 abyss fireball outer damage"),
                new FieldInfo("hybridCoreFireballDamage", "Hybrid Core Fireball Damage", "skill2 core damage"),
                new FieldInfo("giantFireballDamage", "Giant Abyss Fireball Damage", "skill3 skill4 giant damage"),
        ...
        new Section(
            ...
            new[]
            {
                new FieldInfo("meleeDamage", "Melee Damage", "melee attack damage"),
