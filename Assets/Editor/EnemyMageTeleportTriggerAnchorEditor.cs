...
[CustomEditor(typeof(Enemy_MageTeleportTriggerAnchor))]
public class EnemyMageTeleportTriggerAnchorEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        Enemy_MageTeleportTriggerAnchor anchor = (Enemy_MageTeleportTriggerAnchor)target;
        using (new EditorGUI.DisabledScope(true))
        {
            EditorGUILayout.ObjectField("Owner Mage", anchor != null ? anchor.Mage : null, typeof(Enemy_Mage), true);
        }
    ...
    private void OnSceneGUI()
    {
        ...
        Enemy_MageTeleportTriggerAnchor.DrawRange(anchor.transform.position, radius, anchor.name);
