...
[CustomEditor(typeof(Enemy_MageProjectileHoverAreaAnchor))]
public class EnemyMageProjectileHoverAreaAnchorEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        Enemy_MageProjectileHoverAreaAnchor anchor = (Enemy_MageProjectileHoverAreaAnchor)target;
        Enemy_Mage mage = anchor != null ? anchor.Mage : null;

        using (new EditorGUI.DisabledScope(true))
        {
            EditorGUILayout.ObjectField("Owner Mage", mage, typeof(Enemy_Mage), true);
        }
