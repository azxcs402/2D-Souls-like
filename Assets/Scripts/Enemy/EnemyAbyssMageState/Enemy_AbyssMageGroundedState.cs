...
public class Enemy_AbyssMageGroundedState : EnemyState
{
    protected readonly Enemy_AbyssMage mage;

    public Enemy_AbyssMageGroundedState(Enemy_AbyssMage enemy, StateMachine stateMachine)
