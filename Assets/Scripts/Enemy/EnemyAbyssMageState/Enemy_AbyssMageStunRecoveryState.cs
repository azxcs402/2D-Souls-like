...
public class Enemy_AbyssMageStunRecoveryState : EnemyState
{
    ...
    public Enemy_AbyssMageStunRecoveryState(Enemy_AbyssMage enemy, StateMachine stateMachine)
    ...
    private float GetRecoveryClipLength()
    {
        ...
        for (int i = 0; i < clips.Length; i++)
        {
            ...
            if (clip.name == mage.StunRecoveryAnimationState || clip.name == "abyssMageStunRecovery")
            {
