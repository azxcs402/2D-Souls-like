...
public class Enemy_AbyssMageAttackState : Enemy_AbyssMageGroundedState
{
    ...
    public Enemy_AbyssMageAttackState(Enemy_AbyssMage enemy, StateMachine stateMachine)
    ...
    public void AttackTrigger()
    {
        ...
        bool hitPlayer = combat != null && mage != null && combat.AttackTrigger(mage.AbyssMageAttackData);
        if (hitPlayer)
        {
